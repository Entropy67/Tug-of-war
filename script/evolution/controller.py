...
class Controller:
    ...
    def build(self):
        self.dataset = data.MyData(self.saved_qty) ### contains all data
    ...
    def run(self):
        '''
        To be implemented for a specific simulator
        '''
        pass
    ...
    def save_prm(self, filename=""):
        '''
        save the data to a unique file
        if file exist, generate a new filename according to the value of pi
        '''
        v = 0
        prm  = self.prm
